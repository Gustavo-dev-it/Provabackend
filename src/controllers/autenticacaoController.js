...
//API NOSSA MINI API DE ENVIAR EMAIL 
    ...
    try {
        await transporter.sendMail({
            //Atenção, gmail precisa ter uma autenticação de 2 fatores, usar o outlook em EMAIL_USER no  .env
            from: process.env.EMAIL_USER, //Pegamos o email que colocamos no arquivo .env 
